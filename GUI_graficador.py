...
import graficas_guardadas as gr
...
class Cuerpo(tk.Frame):
    ...
    def enviar(self):
        ...
        self.puertos = [f'Puerto {i}' for i in range(1,13)]
    ...
    def graficador(self):
        ...
        gr.graficas_guardadas(self.tk_cliente.get(), self.tk_mes.get(), 
                            self.tk_findero.get(), self.seleccion_grafica)
